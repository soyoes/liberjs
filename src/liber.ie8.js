if (!JSON) {/*For IE~8*/
    ...
    (function () {
        ...
        function quote(string) {
            ...
            return escapable.test(string) ? '"' + string.replace(escapable, function (aa) {
                var c = meta[aa];
        ...
        extend: function(name,fn){
            ...
            if(document.getElementByClassName){
                ...
                document.getElementsByClassName = function(clsname){
                	var _arr = _getElementsByClassName(clsname);
                    for(var _elem=0;_elem<_arr.length;_elem++)
                    	eval("_arr[_elem]." + name + " = fn");
                    return _arr;
                }
            ...
            document.querySelectorAll = function(query){
            	var _arr = _querySelectorAll(query);
                for(var _elem=0;_elem<_arr.length;_elem++)
                	eval("_arr[_elem]." + name + " = fn");
                return _arr;
            }
...
function ie8_enhance(){
    ...
    Element.extend("removeClass",__element.removeClass);
    Element.extend("css",__element.css);
    Element.extend("attr",__element.attr);
    Element.extend("bind",__element.bind);
    Element.extend("animate",__element.animate);
    ...
    var $input = function(args, target){
		...
		if(args.name){
			...
			ipt = $e("input",args, target);
		if(args.placeholder){
			ipt.attr("placeholder",args.placeholder);
		}
		return ipt;
	};
	window.INPUT = $input;
